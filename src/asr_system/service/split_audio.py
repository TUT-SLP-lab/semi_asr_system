...
class Sox_Command:
    ...
    """
    def __init__(self, in_format_op:str=None, out_format_op:str=None, silence_params:list=None):
        ...
        if self.silence_params == None:
            self.silence_params = [1, 0.2, 0.1]*2
...
if __name__ == '__main__':
    sox_com = Sox_Command(
        in_format_op='-V3',
        out_format_op=None,
        silence_params=[1, 0.1, 0.3]*2
    )
    saudio = SplitAudio(sox_com)
    saudio.split('asr_system/sample/input.wav', 'asr_system/sample/output.wav')
